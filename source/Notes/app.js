...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Format the date
    let formattedDate = monthNames[dateInfo.month] + ' ' + dateInfo.day + ' ' + dateInfo.year;
...
function openTab(evt, tabName) {
    ...
    for (i = 0; i < tablinks.length; i++) {
        tablinks[parseInt(i,10)].className = tablinks[parseInt(i,10)].className.replace(" active", "");
    }
